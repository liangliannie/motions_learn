...
def parse():
    ...
    parser.add_argument('--output-path', type=str, dest='output_path', default="/home/liang/Desktop/output_motions",
    ...
    parser.add_argument('--training-file', type=str, dest='training_file', default="/home/liang/Desktop/motion_pickle/",
